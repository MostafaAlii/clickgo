            ...
            <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade @if($loop->index == 0) show active @endif" id="{{$key}}"
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <label for="{{$key}}[name]" class="form-label">{{trans('dashboard/service.name') .
                                        ' / ' . $lang['native']}}</label>
                                    <input type="text" id="{{$key}}[name]" name="{{$key}}[name]"
                                        placeholder="{{trans('dashboard/service.service_name_placeholder') . ' / ' . $lang['native']}}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="{{$key}}[description]"
                                        class="form-label">{{trans('dashboard/service.description') . ' / ' .
                                        $lang['native']}}</label>
                                ...
                                <div class="col-md-6">
                                    <label for="{{$key}}[short_description]"
                                        class="form-label">{{trans('dashboard/service.short_description') . ' / ' .
                                        $lang['native']}}</label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="price" id="price" class="form-control" placeholder="أدخل السعر" step="0.01">
                    </div>
                    <div class="col-md-4" id="providersDropdownRow">
                        <label for="provider_id">مزودى الخدمات</label>
                        <select id="provider_id" name="provider_id" class="form-control">
                            <option value="">اختر المزود</option>
                            @forelse($providers as $provider)
                            <option value="{{ $provider['id'] }}">{{ $provider['name'] }}</option>
                            @empty
                            <option value="">لا توجد مزودى خدمه متاح</option>
                            @endforelse
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="p-3 mb-3 text-center border rounded">
                            ...
                            <input class="form-control" type="file" name="service" id="categoryInput" accept="image/*">
                            <div class="mt-2">
