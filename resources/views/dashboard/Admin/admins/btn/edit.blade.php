<div class="modal fade" id="editAdmin" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <!--begin::Form-->
            <form class="editForm" id="adminEditForm" autocomplete="off">
                <!--begin::Modal header-->
                <div class="modal-header bg-dark">
                    <!--begin::Modal title-->
                    <h2 id="edit-modal-title" class="card-title align-items-start flex-column text-gray-500">
                    ...
                    <div class="scroll-y me-n7 pe-7" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-offset="300px">
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <input type="text" id="name" class="form-control form-control-solid" placeholder="{{ trans('dashboard/admin.type_name_placeholder') }}" name="name" />
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <input type="text" id="email" class="form-control form-control-solid" placeholder="{{ trans('dashboard/admin.type_email_placeholder') }}" name="email" />
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <input type="text" id="phone" class="form-control form-control-solid" placeholder="{{ trans('dashboard/admin.type_phone_placeholder') }}" name="phone" />
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-6 fv-row" id="edit_password_protection_field" style="display:none;">
                        ...
                        <div class="row col-md-6 p-1">
                            <select class="col-md-3 fv-row form-select form-select-solid" aria-label="Select example" name="type">
                ...
                <div class="modal-footer flex-center bg-hover-lighten text-hover-inverse-lighten">
                    ...
                    <!--end::Button-->
                    <!--begin::Button-->
                    <button type="button" id="editSaveBtn" class="btn btn-outline btn-outline-dashed btn-outline-success btn-active-light-success">
