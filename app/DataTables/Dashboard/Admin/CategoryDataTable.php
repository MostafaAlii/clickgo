...
class CategoryDataTable extends BaseDataTable
{
    ...
    public function dataTable($query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('country_id', function (Category $category) {
    return $category->country?->name ?? '<span class="badge bg-secondary">بدون دولة</span>';
})

            ->rawColumns(['country_id','action', 'created_at', 'updated_at', 'category', 'parent_id', 'status']);
    }

    public function query(): QueryBuilder
    {
        return Category::with(['parent', 'country'])->latest();
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            ['name' => 'country_id', 'data' => 'country_id', 'title' => 'الدولة', 'orderable' => false, 'searchable' => false],
