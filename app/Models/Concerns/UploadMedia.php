...
trait UploadMedia {
    ...
    public function uploadGalleryMedia(
        ...
        foreach ($files as $file) {
            ...
            $uploadedFiles[] = $this->uploadSingleMedia(
                $baseFolder,
                $file,
                $model,
                null,
    ...
    public function updateGalleryMedia(
        string $baseFolder,
        array $files,
        $model,
        ?string $relation = null,
        ...
        $this->deleteExistingGalleryMedia($baseFolder, $model, $relation, $useStorage, $collectionName);
        return $this->uploadGalleryMedia(
            $baseFolder,
            $files,
            $model,
            $relation,
    ...
    public function deleteExistingGalleryMedia(
        string $baseFolder,
        $model,
        ?string $relation,
        bool $useStorage,
